  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        <div className="mx-auto mb-3 flex h-16 w-16 items-center justify-center rounded-full bg-[#F5F1FF] dark:bg-[#6C3CE1]/10">
          <svg className="h-8 w-8 text-[#6C3CE1] dark:text-[#B4A0F0]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
